      ...
      {!isLoading && (
        <>
          ...
          <div className="flex m-4 justify-between md:h-96">
            <div className="w-full md:w-[50%] bg-[#E7FAFE] rounded-2xl rounded-r p-2">
              ...
              <h1 className="font-bold md:text-xl text-lg max-w-2xl">{data?.title}</h1>
              <p
            ...
            <div className="w-full md:w-[50%] relative">
              ...
              <img
                src={data?.image || "https://img.spoonacular.com/recipes/639779-556x370.jpg"}
                alt=""
                className="absolute inset-0 md:m-14 md:w-64 md:h-64 h-24 w-24 m-6 rounded-full border border-gray-900"
              />
            </div>
          </div>
            ...
            <div className="relative p-1 flex items-center justify-center">
              <div className="">
                <input
                  ...
                  name=""
                  id=""
                  className="md:w-[500px] w-full pr-36 p-2 rounded-lg"
                />
