...
const ListCard: React.FC<ListCardProps> = ({img, text, onClick}) => {
    ...
    return (
        <div onClick={onClick ? () => onClick() : undefined} className="md:w-20 md:h-20 w-16 flex flex-col items-center rounded-lg bg-gradient-to-t from-[#708246] to-[#708246]/10 mb-2">
