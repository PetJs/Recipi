...
const Card: React.FC<CardProps> = ({img, title, time, food}) =>{
    ...
    return (
        <div className="flex flex-col justify-center  bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD]/10 text-black items-center p-3 rounded-lg">
            ...
            <div>
                <p className="text-ellipsis whitespace-pre-wrap w-[14rem] line-clamp-2 md:text-lg text-[12px] font-bold text-center">{title}</p>
                <div className="flex md:gap-6 gap-2 mt-2 justify-center">
